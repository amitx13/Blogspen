...
export default function NewStory() {
    ...
    return (
        <div className="h-screen pl-10 pr-10 sm:pl-36 sm:pr-36 md:pr-48 md:pl-48 lg:pr-64 lg:pl-64 xl:pl-80 xl:pr-80 2xl:pl-96 2xl:pr-96">
            <div className="flex justify-center">
                <h1 className="text-3xl font-extralight mt-3 ml-4 mr-2">Title</h1>
                <textarea
